...
const Services = () => {
  return (
    <ServicesContainer id='services'>
      ...
      <ServicesH2>We understand the effort and hardship that went into building your business and offer a unique opportunity to monetize your business while preserving your legacy.</ServicesH2>
      <ServicesWrapper>
        <ServicesCard>
